...
def generate():
    ...
    if not mobile.isdigit() or len(mobile) != 10:
        return "<h2>Invalid Mobile Number (Must be 10 digits)</h2>"
    ...
    <h1 style="color:green;font-size:50px;">{token}</h1>
    <a href="/">Back</a>
    """
...
def data():
    ...
    html = "<h2>All Records</h2><table border=1 cellpadding=5>"
